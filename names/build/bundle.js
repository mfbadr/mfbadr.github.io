...
// module
exports.push([module.i, "html, body {\n  margin: 0;\n  height: 100%;\n  background-color: #FFF; }\n\n.control-panel {\n  padding: 2rem;\n  background-color: grey;\n  border-radius: 15px;\n  margin: 2rem; }\n  .control-panel .input-wrapper h3 {\n    display: inline-block; }\n  .control-panel input {\n    width: 60px;\n    height: 40px;\n    outline: 0;\n    border: 0;\n    border-bottom: 4px solid black;\n    background: 0;\n    font-size: 22px; }\n    .control-panel input[type=range] {\n      display: inline-block;\n      max-width: 200px; }\n    .control-panel input[type=number]::-webkit-inner-spin-button, .control-panel input[type=number]::-webkit-outer-spin-button {\n      -webkit-appearance: none;\n      margin: 0; }\n    .control-panel input::placeholder {\n      color: black; }\n    .control-panel input#maxOccurancesInput {\n      width: 100px; }\n  .control-panel #renderYearButton {\n    display: block;\n    margin: 0 auto;\n    margin-top: 2rem;\n    min-width: 200px; }\n\n.name {\n  margin: 0;\n  display: inline-block;\n  padding: 5px; }\n\n.toggleSwitch {\n  position: relative;\n  display: inline-block;\n  width: 60px;\n  height: 34px; }\n  .toggleSwitch input {\n    display: none; }\n    .toggleSwitch input:checked + .toggleSlider {\n      background-color: #2196F3; }\n      .toggleSwitch input:checked + .toggleSlider:before {\n        -webkit-transform: translateX(26px);\n        -ms-transform: translateX(26px);\n        transform: translateX(26px); }\n    .toggleSwitch input:focus + .toggelSlider {\n      box-shadow: 0 0 1px #2196F3; }\n  .toggleSwitch .toggleSlider {\n    border-radius: 34px;\n    position: absolute;\n    cursor: pointer;\n    top: 0;\n    left: 0;\n    right: 0;\n    bottom: 0;\n    background-color: #ea96c3;\n    -webkit-transition: .4s;\n    transition: .4s; }\n    .toggleSwitch .toggleSlider:before {\n      position: absolute;\n      content: \"\";\n      height: 26px;\n      width: 26px;\n      left: 4px;\n      bottom: 4px;\n      background-color: white;\n      -webkit-transition: .4s;\n      transition: .4s;\n      border-radius: 50%; }\n\n.spin {\n  animation: spin;\n  animation-name: spin;\n  animation-duration: 5000ms;\n  animation-iteration-count: infinite;\n  animation-timing-function: linear; }\n\n@keyframes spin {\n  from {\n    transform: rotate(0deg); }\n  to {\n    transform: rotate(360deg); } }\n", ""]);
...
window.onload = function() {
	...
	function renderYear(){
		...
		enterLoadingState();
		__WEBPACK_IMPORTED_MODULE_0_d3__["json"]("static/names_parsed/yob" + currentDisplayYear + ".json", function(error, data) {
	...
	function enterLoadingState(){
		...
		__WEBPACK_IMPORTED_MODULE_2_jquery__('#renderYearButton').hide();
		__WEBPACK_IMPORTED_MODULE_2_jquery__('.spinner-wrapper').show();
	}
	function exitLoadingState(){
		var clearAll = __WEBPACK_IMPORTED_MODULE_0_d3__["select"]('.d3target').selectAll("*").remove();
		__WEBPACK_IMPORTED_MODULE_2_jquery__('#renderYearButton').show();
		__WEBPACK_IMPORTED_MODULE_2_jquery__('.spinner-wrapper').hide();
	}
	...
	function registerInputListeners(){
		...
		__WEBPACK_IMPORTED_MODULE_2_jquery__('#renderYearButton').click(function(e){
			renderYear();
		})

		__WEBPACK_IMPORTED_MODULE_2_jquery__('#minOccurancesInput').blur(function(e){
			if(e.currentTarget.value == ''){
